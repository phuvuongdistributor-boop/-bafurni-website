(() => {
  const products = Array.isArray(window.BA_SL_MEETING_CHAIRS)
  ...
  if (!product) {
    root.innerHTML = `<div class="v10-wrap v10-product-error"><p class="v10-kicker">Không tìm thấy mã</p><h1>Sản phẩm chưa có trong package.</h1><a href="/danh-muc/ghe-hop-chan-quy">Quay lại 22 mẫu ghế họp chân quỳ</a></div>`;
  ...
  document.addEventListener("click", (event) => {
    ...
    const context = {
      ...
      productCategory: "ghe-hop-chan-quy",
      categoryName: "Ghế họp chân quỳ SL The One"
    };
  ...
  window.BA_SL_MEETING_PRODUCT_QA = {
    code: product.code,
