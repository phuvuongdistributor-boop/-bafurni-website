...
| 3 | GL304 và GL345 khác nhau rõ không? | PASS | GL304 rộng 585 mm, khung/chân thép mạ; GL345 rộng 695 mm, có tựa đầu và tay chỉnh cao. Ảnh GL345 được ghi thiếu thay vì mượn ảnh. |
...
| 9 | Có ảnh nào bị upscale giả không? | PASS | 19 ảnh sản phẩm được copy exact-byte; pipeline creative giới hạn scale tối đa 1.0. |
...
Package giúp khách khoanh vùng bằng thông số và cơ cấu thay vì chỉ nhìn ảnh. Điểm hạn chế còn lại là chất lượng/độ phủ ảnh nguồn: 16 mã có ảnh sạch 580×580, 6 mã phải dùng placeholder. Đây là hạn chế nguồn đã được công khai, không phải lỗi mapping.
